        ...
        <div class="container">
            ...
            <nav id="menus" class="navegacao">
                ...
                <ul id="lista" class="menu">
                    ...
                    <li><a href="entregador/index.php">Entregadores</a></li>
    ...
    <main>
        <section class="inicio">
            <div class="container">
                <div class="pesquisa">
                    <h1>PETiu, chegou!</h1>
                    <p>Aqui tem tudo para o seu pet com descontos exclusivos</p>
                    <form class="busca" method="GET" action="store/busca.php" autocomplete="off">
                        <input name="search" id="buscagem" class="ginput" type="text" placeholder="Digite aqui o que você precisa" required/>
                        <input class="gbotao" type="submit" value="Buscar"/>
                    </form>
                </div>
                <div class="cards">
                    <div class="destaques">
                        <a href="store/index.php">
                            <div class="destaquezinho des1">
                                <h2>Produtos</h2>
                                <p>Encontrar opções</p>
                            </div>
                        </a>
                    </div>
                    <div class="destaques">
                        <a href="store/lojas.php">
                            <div class="destaquezinho des2">
                                <h2>Lojas</h2>
                                <p>Buscar lojas</p>
                            </div>
                        </a>
                    </div>
                    <div class="destaques dst">
                        <a href="store/index.php">
                            <div class="destaquezinho des3">
                                <h2>Promoções</h2>
                                <p>Ver promoções</p>
                            </div>
                        </a>
        ...
        <section class="cadastros">
            <div class="container">
                <div class="miolo mprimario">
                    <div class="miolinho esquerda"><img src="images/entregador.png" alt="Entregador"/></div>
                    <div class="miolinho direita">
                        <h2>Fazer entrega de pedidos no Caramel</h2>
                        <p>Você pode começar hoje fazendo entregas para petshops pela plataforma, gerando renda extra</p>
                        <a href="entregador/index.php">Saiba mais</a>
                    </div>
                </div>
                <div class="miolo msecundario">
                    <div class="miolinho esquerda"><img src="images/loja.png" alt="Loja"/></div>
                    <div class="miolinho direita">
                        <h2>Seja uma loja parceira para vender online</h2>
                        <p>Sua força de vendas online para produtos de petshop e derivados, começe agora mesmo</p>
                        <a href="lojista/cadastro.php">Saiba mais</a>
                    </div>
                </div>
            </div>
        </section>
