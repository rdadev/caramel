    ...
    <section>
        <div class="container">
            ...
            <div class="lojas">
                ...
                <?php
                    if($lojas -> rowCount() != 0){  
                        while($loja = $lojas -> fetch()){ 
                            echo ("
                                <a href='petshop.php?id=".$loja["ID_LOJA"]."'><div class='loja'>
                                <img src='".$loja["DS_CAMINHO_IMAGEM_LOJA"]."' alt='Logotipo'/>
                                <h4>".$loja["NM_LOJA"]."</h4>
                                <p>".$loja["NM_BAIRRO_LOJA"]."</p>
                                <p>".$loja["HR_TEMPO_ENTREGA_LOJA"]." min • R$ ".$loja["VL_TAXA_ENTREGA_LOJA"]."</p>
                                </div></a>
                            ");
                        };
                    };
            ...
            <a class="vertudo" href="lojas.php">Ver tudo</a>
        </div>
    </section>
    <section>
        <div class="container">
            ...
            <a class="vertudo" href="alta.php">Ver tudo</a>
        </div>
    </section>
