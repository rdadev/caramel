...
<body>
    <?php
        ...
        if(isset($_GET['id'])) {
            $loja = $conn -> prepare("SELECT * FROM tbl_lojas WHERE ID_LOJA = :id");
            $loja -> bindValue(":id", $_GET['id']);
            $loja -> execute();
            $dados = $loja -> fetch();

            if ($loja -> rowCount() > 0) {
                if ($dados["ST_TURNO_LOJA"] == 0) {
                    echo ("<script>
                    Swal.fire({
                        icon: 'error',
                        title: 'Loja fechada',
                        text: 'Atualmente a loja encontra-se fechada, volte mais tarde!',
        ...
        $secoes -> bindValue(":id", $_GET['id']);
        $secoes -> execute();

        $avaliacoes = $conn -> prepare("SELECT ID_AVALIACAO, TX_AVALIACAO FROM tbl_avaliacoes WHERE ID_LOJA = :id");
        $avaliacoes -> bindValue(":id", $_GET['id']);
        $avaliacoes -> execute();

        $avaliacoes2 = $conn -> prepare("SELECT ID_AVALIACAO, TX_AVALIACAO FROM tbl_avaliacoes WHERE ID_LOJA = :id");
        $avaliacoes2 -> bindValue(":id", $_GET['id']);
        $avaliacoes2 -> execute();

        $avaliacoes3 = $conn -> prepare("SELECT tbl_avaliacoes.ID_AVALIACAO, tbl_avaliacoes.TX_AVALIACAO, tbl_usuarios.NM_USUARIO, tbl_avaliacoes.DS_COMENTARIO_AVALIACAO, tbl_avaliacoes.DT_POSTAGEM_AVALIACAO FROM tbl_avaliacoes, tbl_usuarios WHERE tbl_avaliacoes.ID_LOJA = :id AND tbl_avaliacoes.ID_USUARIO = tbl_usuarios.ID_USUARIO");
        $avaliacoes3 -> bindValue(":id", $_GET['id']);
        $avaliacoes3 -> execute();
    ?>
    ...
    <section class="capa">
        <img src="<?php echo($dados["DS_CAMINHO_CAPA_LOJA"]); ?>" alt="Capa da loja"/>
    </section>

    <section class="introducao">
        <div class="container">
            <div class="store">
                <img class="logor" src="<?php echo($dados["DS_CAMINHO_IMAGEM_LOJA"]); ?>" alt="Logo petshop"/>
                <h2><?php echo($dados["NM_LOJA"]); ?></h2>
                <div class="classificacao"><button type="button" onclick="abrirLateral('#classificacao')"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z"/></svg><p><?php
                    $total = 0;
                    $media = 0;

                    if($avaliacoes -> rowCount() != 0){ 
                        while($avaliacao = $avaliacoes -> fetch()){ 
                            $total = $total + $avaliacao["TX_AVALIACAO"];
                        };
                        $media = $total / $avaliacoes -> rowCount();
                    };
                    
                    echo ($media);
                ?></p></button></div>
                <div class="dirloja">
                    <p class="entpreco">Entrega R$ <?php echo($dados["VL_TAXA_ENTREGA_LOJA"]); ?></p>
                    <p class="separador">|</p>
                    <button class="btl" type="button" onclick="abrirLateral('#sobre')">Sobre a loja</button>
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div class='conteudo'>
                                    ...
                                    <div class='direita'>
                                        ...
                                        <div class='botoes'>
                                            ...
                                            <input name='pg' class='hidden' type='text' value='0'/>
                                            <input name='id_petshop' type='text' class='hidden' value='".$_GET['id']."'/>
    ...
    <section id="sobre" class="lateral">
        <div class="fechar"><span>Sobre a loja</span><button type="button" onclick="fecharLateral()"><svg xmlns="http://www.w3.org/2000/svg" height="28" viewBox="0 96 960 960" width="28"><path d="m249 873-66-66 231-231-231-231 66-66 231 231 231-231 66 66-231 231 231 231-66 66-231-231-231 231Z"/></svg></button></div>
        <div class="conteudo">
            <div class="scs" style="padding-top: 0">
                <h3>Descrição</h3>
                <p><?php echo($dados["DS_LOJA"]); ?></p>
            </div>
            <div class="scs">
                <h3>Endereço</h3>
                <div class="localizacao">
                    <p><?php echo($dados["DS_LOGRADOURO_LOJA"]); ?>, <?php echo($dados["NM_BAIRRO_LOJA"]); ?></p>
                    <p><?php echo($dados["NM_CIDADE_LOJA"]); ?>/<?php echo($dados["SG_UF_LOJA"]); ?></p>
                    <p>CEP <?php echo($dados["NR_CEP_LOJA"]); ?></p>
                </div>
            </div>
            <div class="scs">
                <h3>Contato</h3>
                <p><?php echo($dados["NR_TELEFONE_LOJA"]); ?></p>
                <p><?php echo($dados["DS_EMAIL_LOJA"]); ?></p>
            </div>
            <div class="scs">
                <h3>CNPJ</h3>
                <p><b><?php echo($dados["DS_RAZAO_LOJA"]); ?></b></p>
                <p><?php echo($dados["NR_CNPJ_LOJA"]); ?></p>
            </div>
        </div>
    </section>

    <section id="classificacao" class="lateral">
        <div class="fechar"><span>Avaliações da loja</span><button type="button" onclick="fecharLateral()"><svg xmlns="http://www.w3.org/2000/svg" height="28" viewBox="0 96 960 960" width="28"><path d="m249 873-66-66 231-231-231-231 66-66 231 231 231-231 66 66-231 231 231 231-66 66-231-231-231 231Z"/></svg></button></div>
        <div class="conteudo aval">
            <div class="avalintro">
                <h1>
                <?php
                    $total = 0;
                    ...
                    if($avaliacoes2 -> rowCount() != 0){ 
                        while($avaliacao = $avaliacoes2 -> fetch()){ 
                            $total = $total + $avaliacao["TX_AVALIACAO"];
                        };
                        $media = $total / $avaliacoes -> rowCount();
                    };
                ...
                <div class="estrelas">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path class="ativo" d="M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z"/></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path class="ativo" d="M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z"/></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path class="ativo" d="M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z"/></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path class="ativo" d="M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z"/></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path class="ativo" d="M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z"/></svg>    
                </div>
                <p><?php echo($avaliacoes -> rowCount()); ?> avaliações no total</p>
             </div>
            <ul>

            <?php
                if ($avaliacoes3 -> rowCount() != 0) {
                    while($avaliacao = $avaliacoes3 -> fetch()) {
                        echo("<li class='scs'>");
                        echo("
                            <h3>".strtok(ucfirst(strtolower($avaliacao["NM_USUARIO"])), " ")."</h3>
                            <div class='avalu'>
                                <p class='nota'>".$avaliacao["TX_AVALIACAO"]."</p>
                                <div class='avastars'>");

                                    if ($avaliacao["TX_AVALIACAO"] >= 1) {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path class='ativo' d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");} else {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");};
                                    if ($avaliacao["TX_AVALIACAO"] >= 2) {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path class='ativo' d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");} else {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");};
                                    if ($avaliacao["TX_AVALIACAO"] >= 3) {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path class='ativo' d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");} else {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");};
                                    if ($avaliacao["TX_AVALIACAO"] >= 4) {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path class='ativo' d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");} else {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");};
                                    if ($avaliacao["TX_AVALIACAO"] >= 5) {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path class='ativo' d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");} else {echo("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960'><path d='M480-229 294-117q-8 5-17 4.5t-16-5.5q-7-5-10.5-13t-1.5-18l49-212-164-143q-8-7-9.5-15.5t.5-16.5q2-8 9-13.5t17-6.5l217-19 84-200q4-9 12-13.5t16-4.5q8 0 16 4.5t12 13.5l84 200 217 19q10 1 17 6.5t9 13.5q2 8 .5 16.5T826-504L662-361l49 212q2 10-1.5 18T699-118q-7 5-16 5.5t-17-4.5L480-229Z'/></svg>");};
                                
                                echo("
                                </div>
                                <p class='data'>".date('d/m/Y', strtotime($avaliacao["DT_POSTAGEM_AVALIACAO"]))."</p>
                                <div class='comentario'>
                                    <p>".$avaliacao["DS_COMENTARIO_AVALIACAO"]."</p>
                                </div>
                            </div>
