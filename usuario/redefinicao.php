        ...
        if(isset($_POST["confirmar"])) {
            ...
            if ($codigo == "") {
                ...
                if ($confirmacao -> rowCount() == 1) {
                    ...
                    if ($consulta["NR_CONFIRMACAO_USUARIO"] == $codigo) {
                        $executa = $conn -> prepare("UPDATE tbl_usuarios SET DS_SENHA_USUARIO = :senha, NR_CONFIRMACAO_USUARIO = NULL WHERE ID_USUARIO = :id;");
