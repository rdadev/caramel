    ...
    <?php
        ...
        if(isset($_POST["confirmar"])) {
            ...
            if ($email == "") { 
                ...
                $consultar = $conn -> prepare("SELECT * FROM tbl_usuarios WHERE DS_TEMPMAIL_USUARIO = :email AND NR_CONFIRMACAO_USUARIO = :codigo");
            ...
            if($consultar -> rowCount() == 0) { 
                ...
                $confirma_email = $conn -> prepare("UPDATE tbl_usuarios SET DS_EMAIL_USUARIO = :novo_email, NR_CONFIRMACAO_USUARIO = NULL, DS_TEMPMAIL_USUARIO = NULL, ST_TEMPMAIL_USUARIO = 0 WHERE ID_USUARIO = :id");
                $confirma_email -> bindValue(":id", $dados["ID_USUARIO"]);
                ...
                Swal.fire({
                    ...
                    text: 'Seu e-mail foi alterado, no próximo login você já pode usar o novo endereço.',
