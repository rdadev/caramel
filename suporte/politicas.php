...
<body>
    ...
    <main>
        <section class="conteudo">
            <div class="container">
                <h3 class="caminho"><a href="../index.php">Home</a> > <a href="index.php">Suporte</a> > <a href="politicas.php">Políticas</a></h3>
                <h2>Políticas</h2>
                <a href="../privacidade/index.php" class="acessar">
                    <p>Política de privacidade</p>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20"><path d="m375-240-43-43 198-198-198-198 43-43 241 241-241 241Z"/></svg>
                </a>
                <a href="../termos/index.php" class="acessar afinal">
                    <p>Termos de uso</p>
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20"><path d="m375-240-43-43 198-198-198-198 43-43 241 241-241 241Z"/></svg>
                </a>
            </div>
