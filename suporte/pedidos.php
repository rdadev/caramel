...
<body>
    ...
    <main>
        <section class="conteudo">
            <div class="container">
                <h3 class="caminho"><a href="../index.php">Home</a> > <a href="index.php">Suporte</a> > <a href="pedidos.php">Pedidos</a></h3>
                <h2>Pedidos</h2>

                <button class="acordeon">Meu pedido não chegou</button>
                <div class="painel">
                ...
                <button class="acordeon">Meu pedido chegou com avarias</button>
                <div class="painel">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.</p>
                </div>
                <button class="acordeon">Não consigo entrar em contato com a loja</button>
                <div class="painel">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.</p>
                </div>
                <button class="acordeon">O pedido veio com itens que eu não pedi</button>
                <div class="painel">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.</p>
                </div>
                <button class="acordeon">Meu pedido veio com itens faltando</button>
                <div class="painel">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolores libero provident accusamus voluptatibus iste culpa. Voluptatibus fugiat eveniet natus sequi illo odit pariatur quas, eum ullam amet hic sapiente.</p>
                </div>
            </div>
