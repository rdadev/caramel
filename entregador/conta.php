...
<body class="corpo">
    ...
    <dialog id="alterpass" class="pass" onkeydown="removeBlur()">
        ...
        <div class="conteudo">
            <form class="alterpass" method="" action="conta.php" autocomplete="off">
                <fieldset>
                    <label for="antpass" class="lbs">Senha atual</label>
                    <input class="txti" id="antpass" type="password" placeholder="********"/>
                    <label for="newpass" class="lbs">Nova senha</label>
                    <input class="txti" id="newpass" type="password" placeholder="********"/>
                    <label for="cofpass" class="lbs">Confirmar</label>
                    <input class="txti" id="cofpass" type="password" placeholder="********"/>
                    <input class="bta rbtcontent" type="submit" value="Alterar"/>
                ...
                <div class="container">
                    <form action="" method="">
                        <fieldset style="margin-bottom: 15px;">
                            ...
                            <label for="nome" class="lbs">Nome completo</label>
                            <input id="nome" type="text" class="txti" value="Usuário Teste"/>
                            <label for="cpf" class="lbs">CPF</label>
                            <input id="cpf" type="text" class="txti" value="001.002.003-10"/>
                            <label for="email" class="lbs">Email</label>
                            <input id="email" type="text" class="txti" value="email@dominio.com"/>
                            <label for="telefone" class="lbs">Celular</label>
                            <input id="telefone" type="text" class="txti" value="(41) 91010-2020"/>
                        </fieldset>
                        <fieldset style="margin-bottom: 15px;">
                            <legend><h2>Credenciais</h2></legend>
                            <label for="senha" class="lbs">Senha</label>
                        ...
                        <fieldset style="margin-bottom: 15px;">
                            <legend><h2>Recebimentos</h2></legend>
                            <label class="lbs" for="bancos">Banco</label>
                            <select id="bancos" class="txti selections">
                                <option selected>001 - Banco do Brasil</option>
                                <option>033 - Banco Santander S/A</option>
                                <option>077 - Banco Inter S/A</option>
                                <option>104 - Caixa Econômica Federal</option>
                                <option>237 - Banco Bradesco</option>
                                <option>260 - Nubank I.P.</option>
                                <option>290 - PagBank Pagamentos</option>
                                <option>323 - Mercado Pago</option>
                                <option>341 - Itaú Unibanco</option>
                                <option>422 - Banco Safra</option>
                                <option>748 - Cooperativa Sicredi S/A</option>
                            </select>
                            <label class="lbs" for="agencia">Agência</label>
                            <input id="agencia" type="text" class="txti" placeholder="Código da agência + DV" value="3574"/>
                            <label class="lbs" for="conta">Conta corrente</label>
                            <input id="conta" type="text" class="txti" placeholder="Código da conta + DV" value="010123456-0"/>                    
                        </fieldset>
                        <input type="submit" class="bta" value="Salvar alterações"/>
                        <a class="btb" href="dashboard.php" style="margin-bottom: 20px;">Cancelar</a>
                    </form>
                </div>
            </section>
