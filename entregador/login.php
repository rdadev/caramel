            ...
            <section class="login">
                <div class="container">
                    <div class="containerzinho">
                        ...
                        <p>Entre no portal do entregador para ver rotas e pedidos de entrega</p>
                        <form class="formulario" method="" action="dashboard.php" autocomplete="off">
                            <input class="entradas" type="email" placeholder="email@email.com.br"/>
                            <input class="entradas" type="password" placeholder="********"/>
                            <a class="recuperacao" href="recuperacao.php">Esqueceu a senha?</a>
                            <input class="botao" type="submit" value="Entrar"/>
                            <span class="acao">Quer ser um entregador? <a class="linkacao" href="cadastro.php">Cadastro</a></span>
                        </form>
                    </div>
                </div>
            </section>
