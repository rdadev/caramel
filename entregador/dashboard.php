    ...
    <main>
        ...
        <div class="portal">
            ...
            <section class="cartoes">
                <div class="container">
                    <div class="cartao">
                        <p>Entregas<br/>do dia</p>
                        <button type="button" onclick="escondeValor();"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="m629-419-44-44q26-71-27-118t-115-24l-44-44q17-11 38-16t43-5q71 0 120.5 49.5T650-500q0 22-5.5 43.5T629-419Zm129 129-40-40q49-36 85.5-80.5T857-500q-50-111-150-175.5T490-740q-42 0-86 8t-69 19l-46-47q35-16 89.5-28T485-800q143 0 261.5 81.5T920-500q-26 64-67 117t-95 93Zm58 226L648-229q-35 14-79 21.5t-89 7.5q-146 0-265-81.5T40-500q20-52 55.5-101.5T182-696L56-822l42-43 757 757-39 44ZM223-654q-37 27-71.5 71T102-500q51 111 153.5 175.5T488-260q33 0 65-4t48-12l-64-64q-11 5-27 7.5t-30 2.5q-70 0-120-49t-50-121q0-15 2.5-30t7.5-27l-97-97Zm305 142Zm-116 58Z"/></svg></button>
                        <h3 id="valor">R$ 152,20</h3>
                        <div class="escondido"></div>
                    </div>
                    <div class="cartao" style="float: right; margin-right: 0;">
                        <p>Rotas<br/>finalizadas</p>
                        <h3>8</h3>
                    </div>
                </div>
            </section>
            ...
            <section class="rotas">
                <div class="container">
                    <h2 style="margin-bottom: 15px">Rota atual</h2>
                    <a href="roteamento.php">
                        <ul>
                            <li>
                                <div class="inteiro">
                                    <h3>Petshop Mundopet</h3>
                                    <p class="vlr">R$ 11,25</p>
                                </div>
                                <div class="inteiro">
                                    <p class="km">4,6Km • 3 pedidos</p>
                                </div>
                            </li>
                        </ul>
                    </a>
                ...
                <div class="container">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <p class="vlr">R$ 7,10</p>
                            <p class="km">2,1Km • 2 pedidos</p>
                        </li>
                        <li>
                            <h3>Aviário Paraiso</h3>
                            <p class="vlr">R$ 10,20</p>
                            <p class="km">3,2Km • 4 pedidos</p>
                        </li>
                        <li>
                            <h3>Micromix Animais</h3>
                            <p class="vlr">R$ 18,30</p>
                            <p class="km">6,2Km • 5 pedidos</p>
                        </li>
                        <li>
                            <h3>Amigão Petshop</h3>
                            <p class="vlr">R$ 18,90</p>
                            <p class="km">10,7Km • 6 pedidos</p>
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <section class="mobnavs">
                ...
                <a href="../suporte/index.php" onclick="abrirPesquisa()"><div class="mobnav">
